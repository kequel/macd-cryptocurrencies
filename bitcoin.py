...
#wczytanie danych
data = pd.read_csv('dane/Bitcoin Historical Data.csv', quotechar='"') #quotechar-obsluga cudzysłowów
...
plt.plot(dates, prices, label='Cena zamknięcia Bitcoin', color='blue')
...
plt.title('MACD i SIGNAL dla Bitcoin')
plt.xlabel('Data')
plt.ylabel('Wartość')
plt.legend()
plt.tight_layout()
plt.savefig("wykresy/ms_bitcoin.png", dpi=300)
...
plt.figure(figsize=(10, 5))
plt.plot(dates, prices, label='Cena zamknięcia Bitcoin', alpha=0.5, color='blue')
...
plt.legend()
plt.tight_layout()
plt.savefig("wykresy/sygnaly_bitcoin.png", dpi=300)
...
plt.subplot(3, 1, 1)
plt.plot(dates[:end_idx], prices[:end_idx], label='Cena zamknięcia Bitcoin', color='blue')
plt.title('Notowania Bitcoin (ostatnie 100 dni)')
plt.xlabel('Data')
plt.ylabel('Cena zamknięcia')
plt.legend()
...
plt.title('MACD i SIGNAL dla Bitcoin (ostatnie 100 dni)')
plt.xlabel('Data')
plt.ylabel('Wartość')
plt.legend()
plt.tight_layout()
plt.savefig("wykresy/ms_bitcoin_100dni.png", dpi=300)

# wykres z sygnałami kupna i sprzedaży - pierwsze 100 dni
plt.figure(figsize=(10, 5))
plt.plot(dates[:end_idx], prices[:end_idx], label='Cena zamknięcia Bitcoin', alpha=0.5, color='blue')
...
plt.legend()
plt.tight_layout()
plt.savefig("wykresy/sygnaly_bitcoin_100dni.png", dpi=300)

#symulacja automatycznego handlu
capital = 1000  #kapitał początkowy
position = 0  #liczba posiadanych jednostek Bitcoin
...
plt.legend()
plt.savefig("wykresy/portfel_bitcoin.png")
